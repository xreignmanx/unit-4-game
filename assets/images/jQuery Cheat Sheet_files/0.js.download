...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($) {
    ...
    return {
        init: function init($selector, $links) {
        ...
        getCurrentSource: function getCurrentSource() {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(6), __webpack_require__(5), __webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, settings, versions) {

    return {
        init: function init($modal, $links) {
            // Open links
